                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p class="text-muted font-13 m-b-30">
                                    Check the list of all registered Voters. You can delete based on need.
                                </p>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    ...
                                                                    <li>
                                                                        <form method="post"
                                                                              action="view_voters.php">
                                                                            <input type="hidden" name="voter_id"
                                                                                   value="<?= $row['sn'] ?>">
                                                                            <button type="submit" name="delete_btn" onclick="return confirm('Ready to Delete?')" class="btn btn-link">
                                                                                Delete Record
                                                                            </button>
                                                                        </form>
