                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p class="text-muted font-13 m-b-30">
                                    Check the Voting progress. You can release result after voting
                                </p>
                                <div class="col-md-12">
                                    <button class="btn btn-primary pull-right" onclick="return confirm('Sure to Release Result')?"> Release Result</button>
                                </div>
