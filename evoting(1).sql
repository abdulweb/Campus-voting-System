...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2017 at 06:45 PM
...
(11, 'Ahmad Adeniyi Sharafudeen', 'male', 20, 'ond', 'uploads/aspirant_images/_1491345999DSC_6303.JPG', 654, 234, 18, 0, 'islam', 'Al-Madeenah center, Esanu aje, Ogbomoso', 'Oyo'),
(12, 'Zakariyyah Mujaheedah Olorunju', 'female', 18, 'ond', 'uploads/aspirant_images/_149156159101_dn_sliderhome_0.jpg', 661, 307, 18, 14, 'islam', 'Oyo ile, Oyo State', '0');
...
(6, 12, '0000-00-00', '0000-00-00', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(14, 'PDP', 'People\'s Democratic Party', 'uploads/party_logos/_1491231638pdp-logo.jpg', 'Power to the People'),
(18, 'APC', 'All Progressives Congress', 'uploads/party_logos/_1491231663apcnewlogo.png', 'Change'),
(19, 'LP', 'Labour Party', 'uploads/party_logos/1491231820_Labour_Party_(Nigeria)_logo.jpg', 'Forward Ever'),
...
(10, 'voter_1', '5f4dcc3b5aa765d61d8327deb882cf99', 'VOTER', 'uploads/voter_images/_14917339864.jpg');
...
--
ALTER TABLE `aspirant`
  MODIFY `sn` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `election_date`
--
ALTER TABLE `election_date`
  MODIFY `sn` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `party`
  MODIFY `sn` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `registeration`
  MODIFY `sn` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `sn` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `ward`
--
ALTER TABLE `ward`
  MODIFY `sn` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2579;
--
